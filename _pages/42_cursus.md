...
<meta name="csrf-token" content="O0SGUSgInuv0uP+TN1NTOrY3cFuOiwIIP4wjSORerrkX6J3VanlG47lUq01Bmiocro5KNS2gU5WsTft4xCAhVg==" />
<link rel="stylesheet" media="all" href="/assets/application-f50a37ab3b70106aa2478048a99948a8cc9910aed51eb4891e0b0a0bd5a44451.css" />
<style>
  .deprecated {
...
<script>
  (function() {
    this._user = {
      "login": "seojeong",
      "id": 72431,
      "url": "https://profile.intra.42.fr/users/seojeong"
    };
...
<a href="https://profile.intra.42.fr"><img alt="42" src="https://meta.intra.42.fr/assets/42_logo-7dfc9110a5319a308863b96bda33cea995046d1731cebb735e41b16255106c12.svg" />
</a></div>
...
<span data-login='seojeong'>
seojeong
</span>
<div class='user-profile-picture visible-sidebars' style='background-image: url(https://cdn.intra.42.fr/users/small_seojeong.jpg)'></div>
</a>
...
<li>
<a href="https://profile.intra.42.fr/users/seojeong"><span class='iconf-user'></span>
View my profile
</a></li>
<li>
...
<div class='projects-menu-list'>
<a class="project-item sidebar-item" href="/projects/42cursus-get_next_line"><span class='icon-box-2 project-status-icon'></span>
get_next_line
</a></div>
</div></div>
...
<select name="cursus" id="graph_cursus" style="display:inline" class="form-control"><option value="21">42cursus</option>
<option value="9">C Piscine</option></select>
<input class='hidden' id='graph_campus' value='29'>
<span class='icon-search graph-elem' id='graph_search_icon'></span>
<input id='graph_search' placeholder='Search into graph' style='outline:none;'>
</div>
...
<footer class="legal-mentions text-center text-muted my-4 col-sm-12 flex justify-content-center flex-column flex-sm-row"><a class="text-muted small px-4" href="https://signin.intra.42.fr/legal/terms/6">General term of use of the site</a><a class="text-muted small px-4" href="https://signin.intra.42.fr/legal/terms/5">Privacy policy</a><a class="text-muted small px-4" href="https://signin.intra.42.fr/legal/terms/3">Legal notices</a><a class="text-muted small px-4" href="https://signin.intra.42.fr/legal/terms/2">Declaration on the use of cookies</a><a class="text-muted small px-4" href="https://signin.intra.42.fr/legal/terms/1">Terms of use for video surveillance</a><a class="text-muted small px-4" href="https://signin.intra.42.fr/legal/terms/4">Rules of procedure</a></footer>
</div>
</div>
</div>
...
<script src="/assets/application-45f35e2aeb714603d7f66e59dfcda8feaa89300ba962d6f55d447c48edd8bfa3.js"></script>
